            ...
            <table class="min-w-full border-collapse border border-gray-300">
                <thead>
                    <tr class="bg-gray-100">
                        ...
                        <th class="py-3 px-6 border border-gray-300 text-left">Presensi</th>
                        <th class="py-3 px-6 border border-gray-300 text-left">Tanggal Presensi</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($presences as $presence)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="py-3 px-6 border border-gray-300">{{ $presence->user->nim }}</td>
                            <td class="py-3 px-6 border border-gray-300">
                                <a href="{{ route('mentor.download', $presence->id) }}"
