        ...
        <div class="bg-white shadow rounded-lg p-6 mb-8">
            ...
            <div class="flex justify-between items-center border-b pb-4 mb-4">
                <div class="flex gap-4">
                    <button class="px-4 py-2 text-gray-600 font-medium rounded-md">This course</button>
            ...
            <button class="px-4 py-2 text-blue-600 font-bold bg-blue-100 rounded-md">Januari</button>
            ...
            <table class="w-full text-left border-collapse border border-gray-200">
                ...
                <tbody>
                    <tr>
                        <td class="p-4 border border-gray-200">Mon, 17 January 2025<br>9.00 PM - 12.00 PM</td>
                        <td class="p-4 border border-gray-200">Presensi Sesi 1</td>
                        <td class="p-4 border border-gray-200 text-center">?</td>
                        <td class="p-4 border border-gray-200 text-blue-600 underline cursor-pointer">Submit attendance</td>
                    </tr>
                </tbody>
            </table>
